...
The exceptions are `Price` and `Phone` as they consist only of numbers and require no conversion.
...
For instance, the user may input `add n/John al Doe p/98765432 e/johND@eXaMpLe.com a/NUS #04-02 $/50 sub/PHy lvl/uP stat/nM t/T`
, the stored entry will be `John al Doe Phone: 98765432 Email: johND@eXaMpLe.com Address: NUS #04-02 Tags: [Tutor][Upper Pri][50][Physics][Not Matched]`
